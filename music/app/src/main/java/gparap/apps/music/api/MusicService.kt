...
interface MusicService {
    ...
    @GET("/api/music_folk.php?key=" + AppConstants.API_KEY)
    fun getFolkSongs(): Call<MusicResponseModel?>?

    @GET("/api/music_world.php?key=" + AppConstants.API_KEY)
    fun getWorldSongs(): Call<MusicResponseModel?>?
