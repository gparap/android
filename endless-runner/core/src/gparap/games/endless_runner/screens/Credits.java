...
public class Credits extends Screen {
    ...
    public Credits(EndlessRunner game) {
        super(game);
        isPressedMenu = false;
    }
    ...
    public void show() {
        super.show();
        createFont(20, Color.VIOLET, false);
        createLabels();
        createMenuButton();
    ...
    private void createLabels() {
        labelCredits = new Label(String.format("%s", "\n" +
                "Music: Silver for playing the lead synth\n" +
                "\n" +
    ...
    private void createMenuButton() {
        buttonMenu = new Image(game.getAtlas().findRegion(Globals.BUTTON_MENU));
